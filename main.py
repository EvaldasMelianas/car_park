...
a_date = datetime.strptime("2022-12-13", "%Y-%m-%d")
b_date = datetime.strptime("2023-01-31", "%Y-%m-%d")
c_date = datetime.strptime("2022-02-01", "%Y-%m-%d")
...
b = Transporter(yearly_mileage=50000, plate_number="ASD123", fuel_type="Diesel", exploit_cost=9000.0,
                serviced_at_date=datetime.strptime("2022-12-13", "%Y-%m-%d"), categories="D",
