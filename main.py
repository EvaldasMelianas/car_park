...
b = Transporter(yearly_mileage=50000, plate_number="ASD123", fuel_type="Diesel", exploit_cost=9000.0,
                serviced_at_date="2023-02-15", categories="D",
                fuel_consumption=11.0, insured_at_date="2022-02-16", passenger_seats=8)
